...
var datas=[
    {"did":1,"name":"华电","time":"2017\/01\/12"},
    {"did":2,"name":"广场","time":"2017\/01\/12"},
    {"did":3,"name":"格物","time":"2017\/01\/12"},
    {"did":4,"name":"教十一","time":"2017\/01\/12"},
    {"did":5,"name":"font","time":"2017\/01\/12"},
    {"did":6,"name":"font","time":"2017\/01\/12"},
    {"did":7,"name":"font","time":"2017\/01\/12"},
    {"did":8,"name":"font","time":"2017\/01\/12"}
...
var options={
    ...
    "callBack":function(result){
        ...
        for(var i=0;i<result.length;i++){
            cHtml+="<li>"+"<img class=\"image_size\" src=\"images\/baoweichu"+result[i].did+".jpg\" \/>"+"<br>"+"<span class=\"font\">"+result[i].name+"<\/span>"+"</li>";//处理数据
        }
